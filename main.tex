...
\begin{figure}\sidecaption
  \centering
  \resizebox{\hsize}{!}{
    \includegraphics[width=\textwidth]{./Figures/FE_vs_PCE_CFL_05}
  }
...
with grid crossing instabilities, we will simulate the compression of
a linear elastic soft soil due to the gravity force, \ref{fig:block}.
...
\begin{figure}\sidecaption
  \centering
  \resizebox{\hsize}{!}{
    \includegraphics[width=\textwidth]{./Figures/Block_CFL_01_MPM.png}
  }
  \caption{Geometrical description of a soil block }.}
\label{fig:block-MPM}
\end{figure}
