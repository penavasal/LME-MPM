...
\begin{figure}\sidecaption
  ...
  \caption{Description of MPM standard algorithm.}
...
displacements. In this case, an analytical solution is possible
...
uGIMP shape function \textit{versus} the LME approximation scheme with
...
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Finally, figure \ref{fig:Dyka-OTM-MPM}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}\sidecaption
  \centering
  \resizebox{\hsize}{!}{
...
We have developed a new time integration scheme for MPM, and
...
\message{ !name(main.tex) !offset(-1619) }
