...
In the authors' opinion, the provided results are capable to highlight the capabilities of the LME-MPM-NPC proposed in the present work. It is important to remark the extension of this research: in order to isolate the strength of the proposed methodology, covering spatial and time discretization, only linear elastic problems are assessed. 
...
\newblock {Computer Methods in Applied Mechanics and Engineering},  318: 724--738, 2017.
...
\newblock{International Journal for Numerical Methods in Engineering},  65(13): 2167--2202, 2006.
...
\newblock {International Journal for Numerical Methods in Engineering}, 113: 130--152, 2017.
