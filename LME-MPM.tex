...
The following test was proposed to \PNA{validate} \cancel{measure proof} the ability of the proposed
...
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
This test was \cancel{taken from PhD thesis of Andersen} \PNA{previously proposed by Andersen} (2009)\cite{thesis_Andersen_2009}. The
...
is more stable than the one performed by the Q4, \PNA{although} \cancel{Despite this} is still
