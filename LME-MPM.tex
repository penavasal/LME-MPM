...
%Despite this, 
Thus, the \acrshort{lme} approach adopted in the present work shows a remarkable robustness \sout{in} dealing with unstructured meshes. From this last comparison it can be deduced that \acrshort{lme}  might be an adequate choice approximation technique when dealing with complex domains where a structured mesh is usually not possible .}
