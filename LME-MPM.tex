...
\end{equation}
\MODIFIED{Now, employing the particle integral definition \eqref{eq:particle_riemann_integral} to compute the integral of \eqref{eq:particle_acceleration_forces_II}, and simplifying the it, is possible to achieve a discrete expression o the acceleration forces term as}
%%%%%%%%%%%%%%%%
\begin{equation}
...
\subsection{Impact of two elastic discs}
